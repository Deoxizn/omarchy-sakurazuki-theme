local palette = require("sakurazuki.palette")
local editor = require("sakurazuki.groups.editor")
local syntax = require("sakurazuki.groups.syntax")
local plugins = require("sakurazuki.groups.plugins")
